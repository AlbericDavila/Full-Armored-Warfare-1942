...
#define ORIGINAL_FILE_NAME "UE4Editor-FullArmoredWarfare.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME FullArmoredWarfare
#define DEPRECATED_FORGAME DEPRECATED
#define FULLARMOREDWARFARE_API DLLEXPORT
